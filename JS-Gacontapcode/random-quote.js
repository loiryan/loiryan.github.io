/*
Design: Loi Ryan,
Website 1: http://www.gacontapcode.com/
...
" -Ngạn ngữ Đức-":"Tuần lễ của người chăm chỉ có bảy ngày, còn tuần lễ của kẻ lười biếng có bảy ngày mai.",
" -Sưu tầm-":"Một trong những hạnh phúc lớn nhất ở đời này là tình bạn, và một trong những hạnh phúc của tình bạn là có một người để gửi gắm những tâm sự thầm kín.",
...
" -Sưu tầm-":" Mỗi ngày bạn cho đi một nụ cười thì bạn đã nhận lại một niềm vui.",
...
" -Sưu tầm-":"Tình yêu nâng cao con người thoát khỏi sự tầm thường.",
" -Vito Colerone-":"Người đàn ông không dành thời gian cho gia đình thì không bao giờ trở thành người đàn ông chân chính.",
...
" -Sưu tầm-":"Đúng thời điểm hay không đúng thời điểm không quan trọng. Đúng người hay sai người không quan trọng. Quan trọng là có thương hay không thương. Đã thương thì không đúng thời điểm hay kể cả sai người, cũng chẳng thành vấn đề.",
" -Sưu tầm-":"Trên thế gian này chẳng có vị thần nào đẹp hơn thần  mặt trời, chẳng có ngọn lửa nào kỳ diệu hơn ngọn lửa tình yêu.",
" -Bill Gates-":"Mọi người sẽ không bao giờ ngó ngàng đến lòng tự trọng của bạn, điều mà họ quan tâm chính là thành tựu mà bạn đạt được. Do đó, trước khi có được những thành tựu thì bạn đừng nên quá chú trọng hay cường điệu lòng tự trọng của bản thân mình.",
...
" -Sưu tầm-":"Khi hai người yêu nhau, họ không nhìn nhau mà họ cùng nhìn về một hướng.",
...
" -Sưu tầm-":"Hãy làm cuộc đời bạn tràn đầy sự ngọt ngào. Hãy nói những lời nói thân thương khi bạn còn nghe được và khi tim bạn còn rung động.",
" -Joker-":"Kế hoạch mà diễn ra đúng như dự đoán thì không có gì bất ngờ cả. Cho dù đó là kế hoạch kinh khủng đi chăng nữa.",
" -Gaara-":"Chỉ khi mày chiến đấu cho bản thân mày, mày mới mạnh nhất.",
...
" -Sưu tầm-":"Sự trung thực là điều tốt đẹp nhất bạn có thể đem trao tặng cho một người.",
" -Tào Tháo-":"Không tin thì không dùng, đã dùng là phải tin.",
" -Đoạn Lãng-":"Việc mà Đoạn Lãng ta làm bất luận đúng sai quyết không có chuyện quay đầu! Nếu không thể làm thần cứu thế như Phong Vân ta sẽ làm ma diệt thế chứ quyết không đứng cùng hàng với lũ nhãi nhép vô danh tiểu tốt.",
...
" -Dark Lord Voldemort-":"Trên đời này không có người tốt và người xấu, chỉ có quyền lực và những kẻ quá yếu đuối để có được nó.",
...
" -Sưu tầm-":"Tất cả những gì anh yêu sẽ mất đi một nửa thú vị nếu không có em để cùng chia sẻ.",
...
" -Sưu tầm-":"Em, chỉ mình em mới tạo cho anh cảm giác đang sống… Những người đàn ông khác bảo đã gặp được thiên thần nhưng anh đã thấy em và thế là đủ.",
" -Sưu tầm-":"Không người nào có thể tự nhiên trưởng thành trên đời này và có một cuộc sống hoàn hảo mà không có ít nhất một người hiểu mình",
" -Sưu tầm-":"Chỉ bằng cách chịu đựng sự cô đơn, sự thịnh vượng mới có thể được giữ lại. Sự thật đơn giản nhưng không nhiều người có thể làm được.",
" -Ben Sweetland-":"Thành công là một hành trình, không phải là điểm đến.",
" -Norman Lear-":"Khi tôi nghĩ rằng mình không thể tiếp tục, tôi buộc mình phải tiếp tục. Thành công của tôi dựa trên sự kiên trì, không phải may mắn.",
" -Nho Giáo-":"Hành trình ngàn dặm, bắt đầu với bước đi đầu tiên.",
" -Ralph Waldo Emerson-":"Tự tin là bí quyết thành công đầu tiên.",
 };
